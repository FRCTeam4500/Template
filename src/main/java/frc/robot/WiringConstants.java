...
/**
 * A class that holds wiring details for the robot. These include CAN IDs for
 * motors, as well as ports for the RIO. Each subsystem has its own subclass with
 * subsystem specific information
 */
public class WiringConstants {
  /**
   * A class containing the wiring details for the swerve subsystem.
   * Holds the 8 CAN IDs, as well as DIO ports for the absolute encoders
   */
