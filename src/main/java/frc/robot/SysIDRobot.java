...
public class SysIDRobot extends TimedRobot {
  ...
  public SysIDRobot() {
    int[] ids =
        new int[] {
          FRONT_LEFT_ANGLE_ID, FRONT_RIGHT_ANGLE_ID, BACK_LEFT_ANGLE_ID, BACK_RIGHT_ANGLE_ID
        };
    for (int id : ids) {
    ...
    SysIDCommands commands = fl.getSynchronizedSysID("Swerve", 0.5, 1, 5, fr, bl, br);
