...
public class FeedforwardSim extends SubsystemBase {
    ...
    /**
     * Creates a feedforward sim for a mechanism which gravity acts on with a constant (possibly 0) force
     * <p>
    ...
    /**
     * Creates a feedforward sim for a mechanism which gravity acts on
     * with a force that is proportional to the angle of the mechansim
     * <p>
     * The feedforward constants should be obtained via SysId
     * <p>
