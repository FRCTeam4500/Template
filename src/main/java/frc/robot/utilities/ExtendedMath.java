...
public class ExtendedMath {
  ...
  public static Rotation2d getOptimizedAngleDifference(
      Rotation2d currentAngle, Rotation2d targetAngle) {
   ...
   * @author Bennett
   * @author David
   * @deprecated <strong>Use {@link ExtendedMath#getSpeakerAngle(Translation2d) getSpeakerAngle}
   *     instead
   *     <p></strong>
   */
