...
public class ExtendedMath {
	...
	/**
	 * Returns the length of a in the direction of b.
	 * Calculated as a·b/|b|, or 0 if b is 0.
	...
	/**
	 * piecewise linear function s.t. if input is 0, output is 0, input is 1, output is 1, and it has a deadzone
	 * @param input number, call it x
	 * @param deadzone deadzone size
	 * @return if |x| < deadzone, 0, otherwise it's a line from the deadzone boundary (deadzone,0) through (1,1)
	 */
	...
	/**
	 * wraps a rotation count into a {@link edu.wpi.first.math.geometry.Rotation2d}
	 * @param rotations rotation count
	 * @return the {@link edu.wpi.first.math.geometry.Rotation2d} representing the appropriate angle.
	 */
	 ...
	 * @param threshold defines the rectangle sizes (note that the x-value is half the width, and same for height)
