...
public class PositionMotor extends SubsystemBase implements Loggable {
  ...
  public static PositionMotor fromTalonFX(
      int canID, Consumer<TalonFX> config, FeedbackController fb, ElevatorFeedforward ff) {
  ...
  public static PositionMotor fromRealisticSim(FeedbackController fb, ElevatorFeedforward ff) {
  ...
  public static PositionMotor fromIdealSim(FeedbackController fb) {
