...
public class VelocityMotor extends SubsystemBase implements Loggable {
  ...
  public static VelocityMotor fromTalonFX(
      int canID, Consumer<TalonFX> config, FeedbackController fb, SimpleMotorFeedforward ff) {
  ...
  public static VelocityMotor fromRealisticSim(FeedbackController fb, SimpleMotorFeedforward ff) {
  ...
  public static VelocityMotor fromIdealSim(FeedbackController fb) {
