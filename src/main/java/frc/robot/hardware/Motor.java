...
public class Motor extends SubsystemBase implements Loggable {
     ...
     * <p>
     * <strong> You probably want to use one of the factory methods, rather
     * than the constructor directly!!</strong>
        ...
        switch (type) {
            ...
            case Rotation:
                ...
                ffVolts = ff.kS() * Math.signum(fbVolts) + 
                    ff.kG() * Math.cos(2 * Math.PI * position);
                break;
        }
     ...
     * @param type The type of target the motor is trying to reach
     * @return A TalonFX Motor Controller wrapped in a {@link Motor}. <p>
     * In Simulation, either {@link #fromIdealSim} or {@link #fromRealisticSim} is returned, 
     ...
     * @param ff The feedforward controller used. This can be null!!
     * @param type The type of target the motor is trying to reach
     * @return A SparkMax Motor Controller wrapped in a {@link Motor}. <p>
     * In Simulation, either {@link #fromIdealSim} or {@link #fromRealisticSim} is returned, 
     * depending on whether ff is null
     */
     ...
     * @param ff The feedforward controller used. This can be null!!
     * @param type The type of target the motor is trying to reach
     * @return A TalonSRX Motor Controller wrapped in a {@link Motor}. <p>
     * In Simulation, either {@link #fromIdealSim} or {@link #fromRealisticSim} is returned, 
     * depending on whether ff is null
     */
