...
/**
 * Wrapper class for limelights. An object of this class doesn't own the underlying hardware.
 * In other words, multiple objects can be made for one limelight, and they will all work.
 * That is not recommended though, since each object could change the pipeline.
 * 
 * <pre>
 * //Example Usage
...
public class Limelight {
     ...
     * @param name The name of the limelight. Should be "limelight.xxx"
     * @param pipeline The pipeline to be used. These are configured in a web browser.
     * @param pose The pose of this limelight relative to the bottom center of the robot.
     * This pose is used to update the reading of gamepieces in sim
     */
    ...
    /**
     * @return the horizontal offset from the target in counterclockwise positive degrees.
     * Defaults to 0 if no target is seen
     */
    public double getTX() {
    ...
    /**
     * @return the area taken up by the target in %. Defaults to 0 if no
     * target is seen
     */
    public double getTA() {
     ...
     * obtained using the megatag 1 algorithm.
     */
     ...
     * @return a {@link PoseEstimate} holding information about an estimated pose
     * obtained using the megatag 2 algorithm.
     */
